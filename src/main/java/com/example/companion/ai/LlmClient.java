...
public final class LlmClient {
    ...
    public static String reply(String userText, String gameContext, List<Pipeline.Turn> history) throws Exception {
        ...
        String systemPrompt = CompanionConfig.personality
            ...
            + "\n- Your words are read aloud. Say sizes like \"2 by 2\" not \"2x2\". When you give coordinates, write them as plain comma-separated numbers with a minus sign for negatives and nothing else \u2014 like -918, 107, 5999. Do NOT add axis letters (x, y, z), do NOT write the word negative, and do NOT use brackets or colons; the game reads them aloud for you."
            + "\n\nAccuracy:"
